...
public class DebugRoomVoiceOver : VoiceOverController
{
	...
	public override void Start() {
		base.Start();
		AudioManager.Instance.PlayVoiceOver(FMODManager.Instance.DebugRoomEnter);
	}
	...
	public override void VoiceOverFinished(EventReference eventReference, bool skipped) {
		//GT: wont be needing to exit this scene in this way I suppose
	...
	//GT: not relevant for the debug at the moment
