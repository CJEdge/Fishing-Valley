...
public class LoadCSV {
	private string csvDirectoryName = "Resources/Dialogue/CSVFile";
	...
	//private void LoadInToNode(List<List<string>> results, List<string> headers, DialogueNodeData nodeData) {
	...
	//private void LoadInToNodePort(List<List<string>> results, List<string> headers, DialogueNodePort nodePort) {
		//foreach (List<string> line in results) {
